...
/// <summary> 
/// Controlador de la clase Administrador
/// </summary>  
class Administrador extends Welcome{
...
function __construct() {
    ...
    $this->load->model('/administrador/Especialistas_model');
    $this->load->model('/administrador/Cliente_model');
    $this->load->model('/administrador/Servicio_model');
	$this->load->model('/administrador/Sesion_model');
	$this->load->model('/administrador/Agenda_model');
	$this->load->model('/login/Login_model');
	} 
	 
public function index()
	{	
		//$this->Login_model->comprobar_sesion_adm('administrador');
...
public function agenda()
	{	
		...
		$this->load->view('administrador/agenda/agenda');
		/// <summary> 
...
public function nueva_agenda()
	{	
		$this->load->view('administrador/agenda/agenda_header');
		$this->load->view('administrador/agenda/nueva_agenda');
		/// <summary> 
...
public function editar_agenda() {
		...
		$this->load->view('administrador/agenda/agenda_header');
		$this->load->view('administrador/agenda/editar_agenda',$data);
		/// <summary> 
...
public function ver_agenda() {
		...
		$this->load->helper('form');
		$this->load->view('administrador/agenda/agenda_header');
		$this->load->view('administrador/agenda/ver_agenda',$data);
		/// <summary> 
		...
		if ($this->form_validation->run() == FALSE)
                {
	    			...
	    			/* referencia
                	$this->load->view('administrador/clientes/clientes_header');
                    $this->load->view('administrador/clientes/nuevo_cliente');*/
			...
			if ( ($respuesta = $this->Agenda_model->crearAgenda($data)) == FALSE ) {
            	...
            	redirect('administrador/agenda','refresh');
			}
			else
				$this->load->helper('url');
            	redirect('administrador/agenda','refresh');
...
public function lista_agendas()
{
		...
		$this->load->helper('form');
		$this->load->view('administrador/agenda/agenda_header');
        $this->load->view('administrador/agenda/lista_agendas',$data);
}	
...
public function lista_agendasNoEjecutadas()
{
		...
		$this->load->helper('form');
		$this->load->view('administrador/agenda/agenda_header');
        $this->load->view('administrador/agenda/lista_agendasNoEjecutadas',$data);
}	
...
public function actualizar_agenda(){
		...
		$this->load->helper('url');
        redirect('administrador/lista_agendas','refresh');
...
public function clientes()
	{	
		...
		$this->load->view('administrador/clientes/clientes_header');
		$this->load->view('administrador/clientes/clientes');
	}
...
/// </summary> 	
		...
		if ($this->form_validation->run() == FALSE)
			...
			if ( ($respuesta = $this->Cliente_model->crearCliente($data)) == FALSE ) {
				...
				$this->load->helper('url');
            	redirect('administrador/nuevo_cliente','refresh');
			}
			else
				$this->load->helper('url');
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/clientes/clientes_header');
        $this->load->view('administrador/clientes/lista_clientes',$data);
}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/clientes/clientes_header');
		$this->load->view('administrador/clientes/editar_cliente',$data);
	}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/clientes/clientes_header');
		$this->load->view('administrador/clientes/ver_cliente',$data);
	}
...
/// </summary> 	
		...
		$usuario['usuario'] = $this->Cliente_model->obtenerClientesBusqueda($data);
			...
			if($usuario['usuario'] == FALSE){
				...
				$this->load->helper('url');
        		$this->load->view('administrador/clientes/clientes_header');
				$this->load->view('administrador/clientes/busqueda_nombreNO');
				
			}
			else{
					$this->load->helper('form');
			        $this->load->view('administrador/clientes/clientes_header');
					$this->load->view('administrador/clientes/busqueda_nombre',$usuario);
			}
	}
...
/// </summary> 
		$this->load->view('administrador/especialistas/especialistas_header');
		$this->load->view('administrador/especialistas/especialistas');
	}
...
/// Funcion perteneciente a especialistas
/// </summary> 
public function nuevo_especialista() {

/// <summary> 
/// Sirve para cargar las vistas del header de especialistas y de nuevo especialista y
/// carga el formulario que se usara para crear un especialista
/// </summary> 
		$this->load->helper('form');
		$this->load->view('administrador/especialistas/especialistas_header');
		$this->load->view('administrador/especialistas/nuevo_especialista');
	}
...
/// Funcion perteneciente a especialistas
/// </summary> 
public function recibir_nuevo_especialista(){

/// <summary> 
/// Sirve para cargar las vistas del header de especialistas y de nuevo especialista
/// y crea el formulario que se usara para el nuevo especialista
/// </summary> 
		...
		if ($this->form_validation->run() == FALSE)
			...
			$this->Especialistas_model->crearEspecialista($data);
				$this->load->helper('url');
...
/// </summary> 		
		...
		$this->load->helper('form');
		$this->load->view('administrador/especialistas/especialistas_header');
        $this->load->view('administrador/especialistas/lista_especialistas',$data);
}
...
/// Funcion perteneciente a especialistas
/// </summary> 
public function editar_especialista() {
	
/// <summary> 
/// Sirve para cargar las vistas del header de especialistas y de editar especialista y 
/// setea los parametros adquiridos en especialista con
/// </summary> 
		...
		$this->load->helper('form');
		$this->load->view('administrador/especialistas/especialistas_header');
		$this->load->view('administrador/especialistas/editar_especialista',$data);
	}
...
/// </summary>
		...
		$this->load->helper('form');
		$this->load->view('administrador/especialistas/especialistas_header');
		$this->load->view('administrador/especialistas/ver_especialista',$data);
	}
...
/// Funcion perteneciente a especialistas
/// </summary> 	
public function eliminar_especialista() {
...
/// Funcion perteneciente a especialistas
/// </summary> 
public function actualizar_especialista(){
/// <summary> 
/// dados los parametros en editar especialista los actualiza en el especialista respectivo
///tambien recarga lista clientes
/// </summary>
		...
		$this->Especialistas_model->actualizarEspecialista($data['id'] = $this->uri->segment(3),$data);
		$this->load->helper('url');
        redirect('administrador/lista_especialistas','refresh');
...
/// </summary>
		...
		$this->load->view('administrador/servicios/servicios_header');
		$this->load->view('administrador/servicios/servicios');
	}
...
/// <summary> 
/// Sirve para cargar las vistas del header de servicios y de nuevo servicio y
/// carga el formulario que se usara para crear un servicio
/// </summary>
	
		$this->load->helper('form');
		$this->load->view('administrador/servicios/servicios_header');
		$this->load->view('administrador/servicios/nuevo_servicio');
	}
...
/// Funcion perteneciente a servicios
/// </summary> 
public function recibir_nuevo_servicio(){
/// <summary> 
/// Sirve para cargar las vistas del header de servicios y de nuevo servicio
/// y crea el formulario que se usara para el nuevo servicio
/// </summary>
		...
		if ($this->form_validation->run() == FALSE)
			...
			$this->Servicio_model->crearServicio($data);
				$this->load->helper('url');
            	redirect('administrador/lista_servicios','refresh');
	       	}
	}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/servicios/servicios_header');
        $this->load->view('administrador/servicios/lista_servicios',$data);
}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/servicios/servicios_header');
        $this->load->view('administrador/servicios/editar_servicio',$data);
	}
...
/// </summary>
		...
		$this->load->helper('form');
		$this->load->view('administrador/servicios/servicios_header');
		$this->load->view('administrador/servicios/ver_servicio',$data);
	}
...
/// </summary>
		...
		$this->load->view('administrador/sesiones/sesiones_header');
		$this->load->view('administrador/sesiones/sesiones');
	}
...
/// </summary>
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
		$this->load->view('administrador/sesiones/nueva_sesion',$data);
		...
		if ($this->form_validation->run() == FALSE)
                {
                	...
                	$this->load->view('administrador/sesiones/sesiones_header');
					$this->load->view('administrador/sesiones/nueva_sesion');
                }
        else
                {
			...
			$this->Sesion_model->crearSesion($data);
				$this->load->helper('url');
            	redirect('administrador/sesiones','refresh');
	       	}
}	
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/lista_sesiones',$data);
		//$this->benchmark->mark('final');
		//echo $this->benchmark->elapsed_time('inicio', 'final');
}
			//Botones de la lista de sesiones
			//Lista de sesiones ejecutadas
...
/// </summary> 	
	...
	//	$data['cliente'] = $this->Sesion_model->clienteID($data['sesion']->result()[0]->id_cliente);
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/sesiones_ejecutadas',$data);
}


public function sesiones_retrasadas(){
...
/// </summary> 	
		...
		if(!$data['segmento']){
			$data['sesion'] = $this->Sesion_model->obtenerSesionRetrasada();
		}
		else{
			$data['sesion'] = $this->Sesion_model->obtenerSesiones($data['segmento']);
		}
	...
	//	$data['cliente'] = $this->Sesion_model->clienteID($data['sesion']->result()[0]->id_cliente);
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/sesiones_retrasadas',$data);
}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/sesiones_sinagenda',$data);
}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/sesiones_ejecutadaspagadas',$data);
}
...
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
		$this->load->view('administrador/sesiones/editar_sesion',$data);
	}
...
/// </summary>
		...
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
		$this->load->view('administrador/sesiones/ver_sesion',$data);
	}
...
/// y mediante un formulario permite agregar una agenda a una sesion
/// </summary> 	
	...
	$this->load->view('administrador/sesiones/sesiones_header');
	$this->load->view('administrador/sesiones/agendado',$data);
...
/// </summary> 	
	...
	$data['segmento'] = $this->uri->segment(3);
		...
		if(!$data['segmento']){
			$data['sesion'] = $this->Sesion_model->obtenerSesion_agendar();
		}
		else{
			$data['sesion'] = $this->Sesion_model->obtenerSesiones($data['segmento']);
		}
		$this->load->helper('form');
		$this->load->view('administrador/sesiones/sesiones_header');
        $this->load->view('administrador/sesiones/agendar_sesion',$data);
...
public function usuarios()
	...
	/// </summary>
		...
		$this->load->view('administrador/usuarios/usuarios_header');
		$this->load->view('administrador/usuarios/usuarios');
...
/// <summary> 
/// Sirve para cargar las vistas del header de usuarios y de editar usuario y 
/// setea los parametros adquiridos en usuarios
/// </summary> 	
		...
		$this->load->helper('form');
		$this->load->view('administrador/usuarios/usuarios_header');
		$this->load->view('administrador/usuarios/editar_usuario',$data);
	}
...
/// </summary>
		...
		$this->load->helper('form');
		$this->load->view('administrador/usuarios/usuarios_header');
		$this->load->view('administrador/usuarios/ver_usuario',$data);
	}
...
/// </summary>
		...
		$usuario['usuario'] = $this->Usuario_model->obtenerUsuariosBusqueda($data);
			...
			if($usuario['usuario'] == FALSE){
				...
				$this->load->helper('url');
        		$this->load->view('administrador/usuarios/usuarios_header');
				$this->load->view('administrador/usuarios/busqueda_nombreNO');
				
			}
			else{
					$this->load->helper('form');
			        $this->load->view('administrador/usuarios/usuarios_header');
					$this->load->view('administrador/usuarios/busqueda_nombre',$usuario);
...
/// <summary> 
/// dados los parametros en editar usuario los actualiza en el usuario respectivo
///tambien recarga lista sesiones
/// </summary>
		...
		$this->Usuario_model->actualizarUsuario($data['id'] = $this->uri->segment(3),$data);
		$this->load->helper('url');
        redirect('administrador/lista_usuarios','refresh');
...
/// <summary> 
/// Sirve para cargar las vistas del header de usuarios y de nuevo usuario y
/// carga el formulario que se usara para crear un usuario
/// </summary>

	
		$this->load->helper('form');
		$this->load->view('administrador/usuarios/usuarios_header');
		$this->load->view('administrador/usuarios/nuevo_usuario');
	}
...
/// </summary> 
		...
		$this->load->helper('form');
		$this->load->view('administrador/usuarios/usuarios_header');
        $this->load->view('administrador/usuarios/lista_usuarios',$data);
}
...
/// Funcion perteneciente a usuarios
/// </summary> 
public function recibir_nuevo_usuario(){
/// <summary> 
/// Sirve para cargar las vistas del header de usuarios y de nuevo usuario
/// y crea el formulario que se usara para el nuevo usuario
/// </summary>
...
public function calendario(){
	...
	$prefs['template'] = '
		...
		$prefs['next_prev_url'] = 'https://spaunimet-jinvernon.c9users.io/spaunimetci/administrador/calendario/';
		...
		$this->load->view('administrador/agenda/agenda_header');
		$this->load->view('administrador/agenda/calendario',$data);
}
/*------------------------ FIN CALENDARIO ------------------------------ */
