...
Class User_Authentication extends Welcome
{
    ...
    public function __construct() 
    {
        ...
        // Load database
        $this->load->model('/login/login_model'); //problemas con esto, necesitamos donde ve e 
        //inserta datos para para poner ese load aca
    }
