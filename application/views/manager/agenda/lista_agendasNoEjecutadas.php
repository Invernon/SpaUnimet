<section id="main-content">
		...
		<article>
			<header>
                <h1> Lista de agendas no ejecutadas</h1>
			</header>
			...
			<?php if($agenda != NULL) : ?>
				<?php foreach ($agenda as $agenda_item): 
					$editar = array('manager','editar_agenda', $agenda_item['id']);
                	//$eliminar = array('manager','eliminar_servicio', $servicio_item['id']);
                	$ver = array('manager','ver_agenda', $agenda_item['id']);
                ?>
