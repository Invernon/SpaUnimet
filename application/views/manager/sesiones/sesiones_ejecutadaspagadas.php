<section id="main-content">
		...
		<article>
			<header>
                <div class="row">
                	<h1> Sesiones Ejecutadas y Pagadas </h1>
                </div>
			...
			<div class="row caja_buscar1" >
               ...
               <div class="col col-xs-3">
	         		<button type="button" class="btn btn-info  disabled" onclick="window.location='<?php echo site_url();?>'">Ejecutadas y Pagadas</button>
               </div>
