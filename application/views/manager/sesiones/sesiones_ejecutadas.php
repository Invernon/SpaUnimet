<section id="main-content">
		...
		<article>
			<header>
                <div class="row">
                	<h1> Sesiones ejecutadas sin pagar </h1>
                </div>
			...
			<div class="row caja_buscar1" >
               ...
               <div class="col col-xs-3 ">
      				<button type="button" class="btn btn-info disabled " onclick="window.location='<?php echo site_url();?>'">Ejecutadas sin Pagar </button>
	           </div>
               ...
               <div class="col col-xs-2">
	         		<button type="button" class="btn btn-info  " onclick="window.location='<?php echo site_url("manager/sesiones_sinagenda/");?>'">Sin agendar</button>
               </div>
