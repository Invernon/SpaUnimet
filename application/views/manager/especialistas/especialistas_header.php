...
<html>
     <head>
        ...
        <title>Manager - Especialistas </title>
		<meta charset="utf-8" />
	...
	<div id="container">
		<div id='menu'>
			<ul>
                ...
                <li> <a class='menu-clientes' onclick="window.location='<?php echo site_url("manager/lista_clientes");?>'"> </a> </li>
                <li> <a class='menu-especialistas-active'onclick="window.location='<?php echo site_url("manager/lista_especialistas");?>'"> </a> </li>
