		...
		<div class="formulario"> 
               ...
               <div class="field field_ver"> 
				...
				<div class="field field_ver"> 
               	...
               	<label> Uso de equipo equipo </label>
				<div class="field field_ver"> 
               ...
               <button class="btn btn-info" style="margin-bottom:10px; width:97%;" onClick="window.location.href = '<?php echo base_url();?>manager/lista_servicios';return false;">Regresar</button>
