...
<html>
     <head>
        ...
        <title>Administrador - Especialistas </title>
		<meta charset="utf-8" />
	...
	<div id="container">
		<div id='menu'>
			<ul>
                ...
                <li> <a class='menu-especialistas-active'onclick="window.location='<?php echo site_url("administrador/lista_especialistas");?>'"> </a> </li>
                <li> <a class='menu-servicios' onclick="window.location='<?php echo site_url("administrador/lista_servicios");?>'"> </a> </li>
                <li> <a class='menu-usuarios' onclick="window.location='<?php echo site_url("administrador/lista_usuarios");?>'"> </a> </li>
            </ul>
			</ul>
		</div>
	</div>